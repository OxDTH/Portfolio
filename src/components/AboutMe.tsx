  ...
  return (
    <div className="relative z-10">
      <SectionHeader
        ...
        description={
          <div>
            I&apos;m a <span className="text-about_me_green">self-taught web developer</span> specializing in building <span className="text-about_me_green">Modern Web Applications</span>
          </div>
        }
      />
      <Stars id="about-me" />
      <div className="@container">
        <div className="flex flex-col gap-8 mt-24 @lg:flex-row justify-between">
          <div className="max-w-xl flex-auto">
            <h3 className="text-lg font-semibold leading-8 tracking-tight text-white">Ritik Mohapatra</h3>
            <p className="text-base leading-7 text-about_me_green">Full-stack Web Developer</p>
            <p className="mt-4 text-lg text-gray-500">I&apos;m a self-taught web developer who’s always looking for creative ways to solve real-world problems.</p>
            <p className="mt-4 text-lg text-gray-500">With 1.5 years of experience in frontend development, I've built responsive and interactive web interfaces, and I'm currently diving into backend technologies to become a more versatile developer.</p>
          </div>
          <div className="flex-none mx-auto">
            <Image className="rounded-full object-cover" src="/me.jpg" alt="" height={238} width={238} />
          </div>
        </div>
        <div className="@container">
                ...
                <div className="border-y py-2 border-gray-500/30 mb-6">
                  <div className="flex flex-wrap gap-x-6">
                    <div className="text-lg font-bold leading-9 tracking-tight flex gap-1">
                      <p className="text-white">Odia</p> - <p className="text-gray-500">Native</p>
                    </div>
                    <div className="text-lg font-bold leading-9 tracking-tight flex gap-1">
