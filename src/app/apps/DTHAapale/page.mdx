...
export const appData = {
  ...
  title: "DTH Aapale",
  description:
    "DTH Aapale is a popular paint artist in Mexico, based in Monterrey, NL. she sells her courses online.",
  image: DTHAapale,
  date: "2022-08",
  service: "E-commerce",
...
DTH Aapale's website is mainly powered by Firebase. The website is hosted on Firebase Hosting, the database is on Firestore, and the authentication
