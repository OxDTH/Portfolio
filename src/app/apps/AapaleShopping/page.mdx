...
Aapale Shopping's application is made up of 2 different express servers. Each of this servers is hosted on their own Heroku dyno.

Aapale Shopping's 'App' is the user facing interface. This is where users are able to do all of the actions that are available to them.

Aapale Shopping's 'Dashboard' is the admin's interface. Here the admin is able to create and modify 'Events', start and end 'Events', and view the 'Events' results.
...
\*_Initial load is around ~2 minutes due to free hosting._
